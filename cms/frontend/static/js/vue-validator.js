		...
		Vue.elementDirective('validator', {
			...
			setupFragment: function setupFragment(lazy) {
				...
				this.validator.waitFor(function() {
					...
					extend(vm.$options, {
						_validator: _this.validatorName
					});
