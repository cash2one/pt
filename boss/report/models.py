...
#     pay_price = models.DecimalField(decimal_places=4, null=True, max_digits=25, db_column='PAY_PRICE', blank=True) # Field name made lowercase.
...
#     order_process_time = models.BigIntegerField(null=True, db_column='ORDER_PROCESS_TIME', blank=True) # Field name made lowercase.
...
#     favo_price = models.DecimalField(decimal_places=4, null=True, max_digits=25, db_column='FAVO_PRICE', blank=True) # Field name made lowercase.
#     class Meta:
...
class TongjiRpDTurnoverSummary(models.Model):
    ...
    total_coupon_bring_order = models.DecimalField(null=True, max_digits=47, decimal_places=4, blank=True, verbose_name=u'券带动消费金额')
...
class TongjiRpDTurnoverTradeVolumeSummary(models.Model):
    ...
    total_order_success_price = models.DecimalField(null=True, max_digits=45, decimal_places=4, blank=True, verbose_name=u'成功订单金额')
    total_order_failed_price = models.DecimalField(null=True, max_digits=45, decimal_places=4, blank=True, verbose_name=u'失败订单金额')
    total_order_processing_price = models.DecimalField(null=True, max_digits=45, decimal_places=4, blank=True, verbose_name=u'处理中订单金额')
    total_refund_processing_price = models.DecimalField(null=True, max_digits=45, decimal_places=4, blank=True, verbose_name=u'退款中订单金额')
    total_refund_success_price = models.DecimalField(null=True, max_digits=45, decimal_places=4, blank=True, verbose_name=u'退款成功订单金额')
    total_coupon_cost = models.DecimalField(null=True, max_digits=45, decimal_places=4, blank=True, verbose_name=u'用券核销额')
...
class TongjiRpDTurnoverBusinessSummary(models.Model):
    ...
    avg_user_order_count = models.DecimalField(null=True, max_digits=23, decimal_places=2, blank=True, verbose_name=u'人均笔数')
...
class TongjiRpDTurnoverDaojiaServiceQuality(models.Model):
    ...
    cancel_order_rate = models.DecimalField(null=True, max_digits=24, decimal_places=2, blank=True, verbose_name=u'订单取消率')
    cp_cancel_order_count = models.IntegerField(null=True, blank=True, verbose_name=u'商家取消笔数')
    cp_cancel_order_rate = models.DecimalField(null=True, max_digits=24, decimal_places=2, blank=True, verbose_name=u'商家取消率')
...
class DiTuiInfo(models.Model):
    id = models.AutoField(primary_key=True)
    area = models.CharField(max_length=128)
    community = models.CharField(max_length=128)
    responser = models.CharField(max_length=128)
    action_time = models.CharField(max_length=128)

    class Meta:
        db_table = u'ditui_info'
